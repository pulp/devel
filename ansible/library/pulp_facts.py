...
rpm_dependency_list = list(['nss-tools', 'pygobject3', 'deltarpm', 'kobo', 'puppet', 'python-lxml', 'python-ldap', 'crontabs', 'httpd', 'systemd', 'git', 'mod_ssl', 'python-pycurl', 'python-oauth2', 'policycoreutils-python', 'python-isodate', 'python-nectar', 'libselinux-python', 'python-blinker', 'python-iniparse', 'python-flask', 'mod_wsgi', 'repoview', 'python-mongoengine', 'python-setuptools', 'python-django', 'python', 'python-deltarpm', 'python-rhsm', 'rsync', 'pyliblzma', 'python-httplib2', 'm2crypto', 'genisoimage', 'createrepo', 'python-twisted-core', 'python-qpid', 'mod_xsendfile', 'python-twine', 'selinux-policy', 'python-pymongo', 'python-gnupg', 'gofer', 'ostree', 'python-semantic_version', 'openssl', 'acl', 'createrepo_c', 'yum', 'python-okaara', 'gnupg', 'python-gofer', 'python-celery'])
